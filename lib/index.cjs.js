...
var usePubState = function usePubState(stateName) {
  var _useState = react.useState(Symbol(stateName)),
      uuid = _useState[0];
...
var useSharedState = function useSharedState(stateName, initValue) {
  var _useState2 = react.useState(getState(stateName, initValue)),
      value = _useState2[0],
      setValue = _useState2[1];

  var _useState3 = react.useState(Symbol(stateName)),
      uuid = _useState3[0];
...
exports.usePubState = usePubState;
